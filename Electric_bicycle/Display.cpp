...
void Display::show_all(double speed, double battery, int gear, double travel_distance) {
	...
	cout << "\033[2K\t\t\t*=============================================*\n";
	cout << "\033[2K\t\t\t|                                             |\n";
	if (speed >= 10) { cout << "\033[2K\t\t\t|\t\t 속도: " << fixed << setprecision(2) << speed << " km/h             |\n"; }
	else { cout << "\033[2K\t\t\t|\t\t 속도: " << fixed << setprecision(2) << speed << " km/h              |\n"; }

	if ((int)battery < 10) { cout << "\033[2K\t\t\t|\t\t 배터리: " << fixed << setprecision(2) << (int)battery << "%                   | \n"; }
	else { cout << "\033[2K\t\t\t|\t\t 배터리: " << fixed << setprecision(2) << (int)battery << "%                  | \n"; }
